...
- prefer Pi-native commands such as `/genesis-start`, `/genesis-init`, `/genesis-open`, `/genesis-status`, `/genesis-dashboard`, `/genesis-plan`, `/genesis-resume`, `/genesis-doctor`, `/genesis-next`, `/genesis-blockers`, `/genesis-compile`, `/genesis-export`, `/genesis-checkpoint`, `/genesis-ingest`, `/genesis-voice-ingest`, and `/genesis-voice-drift`
