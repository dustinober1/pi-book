...
test("draft prompt does not turn audit metrics into prose quotas", () => {
  const context = {
    root: "/tmp/phase5-placeholder", bookId: "book-01",
    packet: {
    ...
    text: "# Drafting Context", report: { estimatedTokens: 10, included: [], excluded: [], graph: { maxDepth: 2 as const, selections: [], blocked: [] } },
  };
