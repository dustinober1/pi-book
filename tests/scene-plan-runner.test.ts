...
function capsule(): ActiveContextCapsule {
  return {
    ...
    opening_rules: ["Use only supplied records."],
    records: [{
      id: "CAN-ACCESS", kind: "canon", status: "locked-canon", authority: "established", required: true,
      reason: "explicit scene contract reference", source_path: "series/canon.yaml", source_hash: "c".repeat(64),
      version: 1, payload: { fact: "The credential is revoked." }, dependencies: [], estimated_tokens: 20,
    }],
