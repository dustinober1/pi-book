...
test("Pi adapter exposes the guided shell, browser wizard, power-user commands, administration, and the transactional event tool", () => {
  ...
  const normal = ["novel", "novel-wizard", "novel-start", "novel-status", "novel-budget", "novel-context", "novel-plan", "novel-run", "novel-draft", "novel-review", "novel-readers", "novel-revise", "novel-package", "novel-adopt", "novel-organize"];
