...
test("Pi adapter exposes nine normal commands, migration, and the transactional event tool", () => {
  ...
  const normal = ["novel-start", "novel-status", "novel-plan", "novel-run", "novel-draft", "novel-review", "novel-readers", "novel-revise", "novel-package"];
