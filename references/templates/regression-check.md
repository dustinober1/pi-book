...
- Generated: pending
- Revision scope: pending

## Verdict

- Overall: pending
- Safe to continue?: pending
- Gate status recommendation: pending

## Regression dimensions

| Dimension | Verdict | Evidence | Required action |
| --- | --- | --- | --- |
| PRD / accepted decisions | pending | pending | check against book-prd, traceability, and decision-ledger |
...
- Revision tickets created:
- Writer questions created:
