...
For AI thrillers and system-driven fiction, also use:
- `docs/ai-thriller-qa-checklist.md` as a fast developmental check
- `docs/ai-thriller-review-prompt.md` as a reusable review prompt for publication-facing critique
