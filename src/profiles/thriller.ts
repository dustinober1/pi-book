...
const genreSettingsSchema = Type.Object({
  thriller_type: Type.Union([
    Type.Literal("techno"), Type.Literal("military-intelligence"), Type.Literal("political"),
    Type.Literal("psychological"), Type.Literal("legal"), Type.Literal("medical"),
    Type.Literal("espionage"), Type.Literal("crime"), Type.Literal("domestic"),
    Type.Literal("action"), Type.Literal("conspiracy"),
  ]),
