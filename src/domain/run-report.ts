...
export const ModelCallReportSchema = Type.Object({
  ...
  inputTokensEstimated: Type.Optional(Type.Boolean()),
  estimatedInstructionTokens: Type.Optional(Type.Integer({ minimum: 0 })),
  estimatedEvidenceTokens: Type.Optional(Type.Integer({ minimum: 0 })),
  totalReservedTokens: Type.Optional(Type.Integer({ minimum: 0 })),
  inputTokenEstimateRatio: Type.Optional(Type.Number({ minimum: 0 })),
  cachedInputTokens: Type.Optional(Type.Integer({ minimum: 0 })),
  outputTokens: Type.Optional(Type.Integer({ minimum: 0 })),
  outputTokensEstimated: Type.Optional(Type.Boolean()),
