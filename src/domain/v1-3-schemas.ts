...
const NullableHashSchema = Type.Union([Type.String({ pattern: "^[a-f0-9]{64}$" }), Type.Null()]);
...
export const TasteProfileSchema = Type.Object({
  ...
  opening_experiment: Type.Object({
    status: Type.Union([Type.Literal("not-started"), Type.Literal("planned"), Type.Literal("accepted"), Type.Literal("rejected")]),
    experiment_id: Type.Union([Type.String({ pattern: "^VE-[0-9]{3}$" }), Type.Null()]),
...
export const VoiceExperimentIndexSchema = Type.Object({
  ...
  experiments: Type.Array(Type.Object({
    ...
    status: Type.Union([Type.Literal("planned"), Type.Literal("drafting"), Type.Literal("scoring"), Type.Literal("accepted"), Type.Literal("rejected")]),
...
export const ResearchLedgerSchema = Type.Object({
  ...
  items: Type.Array(Type.Object({
    ...
    notes: Type.String(),
    status: Type.Union([Type.Literal("planned"), Type.Literal("researching"), Type.Literal("ready"), Type.Literal("deferred"), Type.Literal("rejected")]),
  }, { additionalProperties: false })),
}, { additionalProperties: false });
...
export const VoiceAuditsSchema = Type.Object({
  ...
  audits: Type.Array(Type.Object({
    id: Type.String({ minLength: 1 }), scope: Type.String({ minLength: 1 }), baseline_hash: Type.String({ pattern: "^[a-f0-9]{64}$" }),
