...
export function registerNovelForge(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    promptGuidelines: ["Use novel_apply_event for Novel Forge planning, drafting, review, revision, canon lock, and packaging changes. Never write Novel Forge state files directly."],
    parameters: Type.Object({
      ...
      event_type: Type.Union([
        ...
        Type.Literal("revise"), Type.Literal("canon-lock"), Type.Literal("package"),
      ]),
