...
export function compileLegacyChapterContract(packet: ChapterPacket): ChapterContract {
  ...
  return {
    ...
    active_thread_ids: [...new Set(packet.story_thread_refs)],
    required_record_ids: [...new Set([...packet.continuity_refs, ...packet.character_refs, ...packet.story_thread_refs, ...packet.required_research])],
    start_state_ids: [],
    required_end_state: [],
    forbidden_changes: [],
