...
Install the verified 1.6.0 release from its pinned Git tag:
...
The matrix runs on Node 22.19.0 and Node 24. See `CHANGELOG.md`, `RELEASE.md`, and `docs/releases/v1.6.0.md` for the current release record. The development branch may contain unreleased changes after the tag, so install `v1.6.0` rather than an unpinned branch for a reproducible pilot.
